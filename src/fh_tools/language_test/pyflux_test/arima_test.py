...
@author: 竹间为简
@published in: 简书 链接：https://www.jianshu.com/p/cced6617b423
"""
...
daily_payment = pd.read_csv(r'D:\WSPych\RefUtils\src\fh_tools\language_test\pyflux_test\399006SH.csv',
...
if __name__ == "__main__":
    run_aram(daily_payment, maxar=5, maxma=12)
