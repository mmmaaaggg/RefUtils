...
@desc    : https://github.com/princewen/tensorflow_practice/blob/master/RL/Basic-AC-Demo/AC.py
"""
import numpy as np
...
class Actor(object):
    ...
    def choose_action(self, s):
        ...
        p_value = probs.ravel()
        choice = np.random.choice(np.arange(probs.shape[1]), p=p_value)  # return a int
        print("probs.ravel():", probs.ravel(), "choice:", choice)
        return choice
