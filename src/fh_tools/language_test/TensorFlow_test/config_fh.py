...
def get_db_engine(db_name='dev_db') -> object:
    """初始化数据库engine"""
...
def get_redis() -> Redis:
    logger.info("初始化redis数据库{} {} {}".format(REDIS_DB_HOST,REDIS_DB_PORT,REDIS_DB_DB))
    r = Redis(host=REDIS_DB_HOST, port=REDIS_DB_PORT, db=REDIS_DB_DB)
