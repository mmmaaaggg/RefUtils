...
holding_df = pd.read_excel(r"d:\Downloads\alpha1_20170619_160622.xls", index_col=0)
buying_df = pd.read_excel(r"d:\Downloads\SectorRotation2017-06-20.xlsx", index_col=0)
