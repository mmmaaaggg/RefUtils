...
class MyMdApi(MdApi):
    ...
    def OnRspSubMarketData(self, spec_instrument, info, requestid, islast):
       print("OnRspSubMarketData: %s" % spec_instrument)
    ...
    def OnRtnDepthMarketData(self, depth_market_data):
        ...
        print(depth_market_data.BidPrice1, depth_market_data.BidVolume1, depth_market_data.AskPrice1,
              depth_market_data.AskVolume1, depth_market_data.LastPrice, depth_market_data.Volume,
              depth_market_data.UpdateTime, depth_market_data.UpdateMillisec, depth_market_data.InstrumentID)
...
def main():
    ...
    user = MyMdApi(instruments=inst,
                   broker_id=b'9999',
                   investor_id=b'13522870868',
                   passwd=b'12348765')
    user.Create(b"data")
    user.RegisterFront(b'tcp://180.168.146.187:10010')
    user.Init()
